...
import com.ppem.psu.mushroomdemo4.Controllers.BedDAO;
import com.ppem.psu.mushroomdemo4.Controllers.CellDAO;
import com.ppem.psu.mushroomdemo4.Controllers.ChartDAO;
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            Toast.makeText(RoomView.this, "Deleted all rooms for " + thePlantName, Toast.LENGTH_SHORT).show();
                        }})
                    .setNegativeButton("Cancel", null).show();
            return true;
