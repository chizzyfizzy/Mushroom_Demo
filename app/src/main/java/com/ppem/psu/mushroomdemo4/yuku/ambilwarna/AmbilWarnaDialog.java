package com.ppem.psu.mushroomdemo4.yuku.ambilwarna;
...
public class AmbilWarnaDialog {
     ...
     */
    public AmbilWarnaDialog(final Context context, int color, AmbilWarnaDialog.OnAmbilWarnaListener listener) {
     ...
     * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
     */
    public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, AmbilWarnaDialog.OnAmbilWarnaListener listener) {
